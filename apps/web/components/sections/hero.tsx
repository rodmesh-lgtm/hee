...
export function HeroSection() {
  return (
    <section id="home" className="relative overflow-hidden py-10 md:py-16">
      <div className="absolute inset-x-0 top-0 -z-10 h-[520px] bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.24),transparent_32%),radial-gradient(circle_at_top_right,rgba(14,165,233,0.14),transparent_26%),linear-gradient(180deg,rgba(255,255,255,0.95),rgba(248,250,252,0))] dark:bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.5),transparent_32%),radial-gradient(circle_at_top_right,rgba(14,165,233,0.28),transparent_26%),linear-gradient(180deg,rgba(2,6,23,0.96),rgba(2,6,23,0))]" />
      ...
      <Container className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        >
          ...
          <motion.h1
            ...
            className="mt-6 text-4xl font-black leading-[1.35] text-slate-950 dark:text-white md:text-5xl lg:text-6xl"
          >
            الهوية الرقمية
            <br />
        ...
        <div className="relative flex justify-center">
          <motion.div
            ...
            transition={{ duration: 0.45, ease: "easeOut" }}
            className="absolute -left-4 top-8 h-24 w-24 rounded-full bg-indigo-400/30 blur-3xl dark:bg-indigo-500/25"
          />
          <motion.div
            initial={{ opacity: 0, scale: 0.96 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.45, delay: 0.05, ease: "easeOut" }}
            className="absolute -right-4 bottom-8 h-28 w-28 rounded-full bg-cyan-400/30 blur-3xl dark:bg-cyan-500/20"
          />

          <GradientBackground className="w-full max-w-[440px] p-5">
