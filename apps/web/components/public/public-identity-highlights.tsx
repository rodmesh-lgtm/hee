...
function Highlights({ companyProfileUrl, companyProfileTitle, socialLinks }: Props) {
  return <div data-public-identity-highlights className="grid overflow-hidden rounded-[18px] border border-[#dce7e5] bg-[#f9fcfb]">
    {companyProfileUrl ? <Link href={companyProfileUrl} target="_blank" rel="noreferrer" className="group flex min-h-[72px] items-center gap-3 px-4 py-3 transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#00a99d] active:scale-[.99]">
    ...
    {socialLinks.length ? <div className="flex min-h-[72px] flex-wrap items-center gap-3 border-t border-[#dce7e5] px-4 py-3 sm:flex-nowrap">
