...
const pageTitles: Record<string, string> = {
  ...
  "/dashboard/whatsapp": "تسويق واتساب",
  "/dashboard/whatsapp/inbox": "صندوق واتساب",
  "/dashboard/whatsapp/contacts": "جهات اتصال واتساب",
  "/dashboard/whatsapp/templates": "قوالب واتساب",
  "/dashboard/whatsapp/campaigns": "حملات واتساب",
  "/dashboard/whatsapp/setup": "ربط WhatsApp Business",
  "/dashboard/whatsapp/audit": "سجل تدقيق واتساب",
