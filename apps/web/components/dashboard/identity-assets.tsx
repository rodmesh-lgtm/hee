...
function safeFileName(value: string) {
  return value.replace(/[^a-z0-9\u0600-\u06ff-]+/gi, "-").replace(/-+/g, "-").replace(/^-|-$/g, "") || "ir-business";
}
