...
function savedTheme():Theme|null{if(typeof window==="undefined")return null;try{const value=localStorage.getItem(KEY);return value==="dark"||value==="light"?value:null}catch{return null}}
function initialTheme():Theme{return savedTheme()??systemTheme()}
