...
const features = [
  ...
  { icon: Palette, title: "مظهر احترافي", text: "قالب HEE موحد ومصمم للجوال أولًا، مع تخصيص ألوان الهوية من لوحة المنشأة." },
...
const plans = [
  {
    ...
    items: ["صفحة أعمال HEE", "حتى 3 منتجات", "فرع واحد وفريق محدود", "معاينة قبل النشر"],
  },
  {
    name: "Business",
    price: "199 ر.س / شهر",
