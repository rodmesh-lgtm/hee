  ...
  return <main dir="rtl" className="min-h-screen bg-[radial-gradient(circle_at_top,#201536_0,#100b1b_42%,#08060d_100%)] px-4 py-10 text-white">
    <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-md items-center">
      <section className="w-full rounded-[30px] border border-white/10 bg-white/[0.06] p-6 shadow-[0_30px_100px_rgba(0,0,0,.45)] backdrop-blur-xl sm:p-8">
        ...
        <div className="mt-5 text-center"><p className="text-xs font-black tracking-[.18em] text-violet-300">INFRO CONTROL PLANE</p><h1 className="mt-2 text-2xl font-black">إدارة المنصة المركزية</h1><p className="mt-2 text-sm leading-6 text-white/55">بوابة مستقلة ومخصصة لمشغلي INFRO فقط. جلسة العميل العادية لا تمنح أي صلاحية إدارية.</p></div>
