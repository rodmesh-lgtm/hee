  ...
  const user = await db.user.findFirst({
    ...
    select: {
      ...
      redeemedAccessGrants: {
        ...
        take: 20,
        select: { id: true, createdAt: true, revokedAt: true, business: { select: { id: true, name: true } }, plan: { select: { code: true, name: true } }, subscription: { select: { status: true, provider: true, endsAt: true } } },
      },
      businesses: {
