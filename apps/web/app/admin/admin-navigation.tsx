...
import { CalendarDays, BellRing, Boxes, CircleHelp, CreditCard, FileText, KeyRound, LayoutDashboard, MessageCircleMore, Palette, ShoppingBag, Users, Building2, ArrowUpLeft, MoreHorizontal, X, type LucideIcon } from "lucide-react";

type NavItem = { href: string; label: string; icon: LucideIcon; badge?: string };
type NavGroup = { label: string; eyebrow: string; items: NavItem[] };

const groups: NavGroup[] = [
  { label: "المنصة", eyebrow: "PLATFORM", items: [{ href: "/admin", label: "مركز القيادة", icon: LayoutDashboard }, { href: "/admin/design", label: "التصميم والهوية", icon: Palette, badge: "STUDIO" }, { href: "/admin/booking-forms", label: "نماذج الحجز", icon: CalendarDays }, { href: "/admin/businesses", label: "المنشآت", icon: Building2 }] },
