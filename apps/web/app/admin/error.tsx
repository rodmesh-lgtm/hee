...
export default function AdminError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <main dir="rtl" className="min-h-screen bg-[#f7f8fb] px-4 py-12 text-[#1f2552] sm:px-6">
      <section className="mx-auto max-w-xl rounded-[26px] border border-rose-200 bg-white p-6 text-center shadow-sm sm:p-8" role="alert">
        <span className="text-2xl font-black tracking-[-.08em] text-[#6f3bd2]">HEE</span>
