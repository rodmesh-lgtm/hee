  ...
  return <div className="space-y-4 pb-6">
    <section className="rounded-[28px] border border-[#dbe8e6] bg-[linear-gradient(135deg,#effbf9,#fff)] p-5 dark:border-[#164443] dark:bg-[linear-gradient(135deg,#082d2e,#061c1f)] sm:p-6">
      <div className="flex items-start gap-3">
        ...
        <div><p className="text-[10px] font-black tracking-[.16em] text-[#008f87] dark:text-[#43dfd0]">INFRO TRUST LAYER</p><h1 className="mt-2 text-2xl font-black text-[#0a2426] dark:text-[#f4fffd]">توثيق صفحة المنشأة</h1><p className="mt-2 max-w-2xl text-sm leading-7 text-slate-500 dark:text-slate-300">اطلب مراجعة صفحة منشأتك للحصول على شارة توثيق INFRO. التوثيق منفصل عن تأكيد البريد ولا يُمنح تلقائيًا.</p></div>
      </div>
    </section>
    ...
    <section className="rounded-[24px] border border-[#dbe8e6] bg-white p-5 dark:border-[#164443] dark:bg-[#092426]">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div><p className="text-[10px] font-black tracking-[.14em] text-[#008f87] dark:text-[#43dfd0]">CURRENT STATUS</p><h2 className="mt-2 font-black text-[#0a2426] dark:text-[#f4fffd]">{business.name}</h2><p className="mt-1 text-xs text-slate-500 dark:text-slate-300">حالة التوثيق الحالية</p></div>
    ...
    <section className="rounded-[24px] border border-[#dbe8e6] bg-white p-5 dark:border-[#164443] dark:bg-[#092426]">
      <div className="flex items-start gap-3"><span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-[#e7f8f5] text-[#008f87] dark:bg-[#0a3b3b] dark:text-[#43dfd0]"><ShieldCheck className="h-5 w-5" /></span><div><h2 className="font-black text-[#0a2426] dark:text-[#f4fffd]">مراجعة بشرية قبل منح الثقة</h2><p className="mt-2 text-xs leading-6 text-slate-500 dark:text-slate-300">يمكن لكل عميل إرسال طلب توثيق صفحته إلى إدارة INFRO. يراجع الفريق الطلب وبيانات المنشأة، ولا يستطيع العميل منح الشارة لنفسه. تظهر الشارة على الصفحة العامة فقط بعد اكتمال المراجعة واعتماد المنشأة.</p></div></div>
    </section>
  </div>;
}
