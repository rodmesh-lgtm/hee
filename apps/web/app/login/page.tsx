        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-[28px] border border-[#dfe9e8] bg-white p-5 shadow-[0_28px_80px_-58px_rgba(7,24,27,.65)] sm:p-7">
            ...
            <div className="mt-5 grid gap-3" aria-label="تسجيل الدخول عبر مزود خارجي">
              <Link href="/api/auth/oauth/google" prefetch={false} className="flex h-12 items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-black text-slate-800 transition hover:border-[#9fe8df] hover:bg-[#f7fcfb] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00bfae] focus-visible:ring-offset-2"><GoogleMark /><span>المتابعة باستخدام Google</span></Link>
              <Link href="/api/auth/oauth/apple" prefetch={false} className="flex h-12 items-center justify-center gap-3 rounded-2xl bg-black px-4 text-sm font-black text-white transition hover:bg-[#1c1c1e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"><AppleMark /><span>المتابعة باستخدام Apple</span></Link>
            </div>
...
export default function LoginPage() {return <Suspense fallback={<main className="min-h-screen bg-[#f4f8f8]" />}><LoginContent /></Suspense>}
