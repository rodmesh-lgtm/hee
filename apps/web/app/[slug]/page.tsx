...
import { PublicBusinessPageV9 } from "../../components/public-business-page-v9";
...
export default async function PublicBusinessPageRoute({params}:{params:Promise<{slug:string}>}){
 ...
 return <><script type="application/ld+json" dangerouslySetInnerHTML={{__html:safeJsonLd(structuredData)}}/><PublicBusinessPageV9 business={business} qrDataUrl={qrDataUrl} publicUrl={publicUrl}/></>;
}
