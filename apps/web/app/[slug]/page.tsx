...
export default async function PublicBusinessPageRoute({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLd(structuredData) }} /><PublicBusinessAnalytics slug={business.slug} /><PublicBusinessPageV10Light business={publicBusiness} qrDataUrl={qrDataUrl} publicUrl={publicUrl} /></>;
}
