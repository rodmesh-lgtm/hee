...
import { PublicBusinessPageV8 } from "../../components/public-business-page-v8";
...
export default async function PublicBusinessPageRoute({params}:{params:Promise<{slug:string}>}){
 ...
 return <><script type="application/ld+json" dangerouslySetInnerHTML={{__html:safeJsonLd(structuredData)}}/><PublicBusinessPageV8 business={business} qrDataUrl={qrDataUrl} publicUrl={publicUrl}/></>;
}
