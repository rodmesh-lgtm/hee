  ...
  const DesktopBusinessProfile = () => (
    <div className="hidden md:block">
      <div className="mx-auto w-full max-w-[1080px] px-7 py-6">
        ...
        {branchDisplay ? (
          <details className="rounded-[16px] border border-[#eeeaf5] bg-white px-4 py-3">
            <summary className="cursor-pointer list-none text-[12px] font-black text-[#2e2446]">
              <span className="text-[10px] text-[#81798d]">فروعنا · </span>
              {branchDisplay.label}
              <span className="float-left text-[#5D43EF]">⌄</span>
            </summary>
            <p className="mt-2 text-[10px] leading-5 text-[#6d6678]">{branchDisplay.detail}</p>
          </details>
        ) : null}
